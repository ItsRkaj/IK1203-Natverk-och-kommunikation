...
public class ConcHTTPAsk{
    ...
    public static void main( String[] args) throws IOException, InterruptedException {
        ...
        for (int i = 0; i < threads.length; i++) {
            Multithredable mt = new Multithredable(serverSocket);
    ...
    public static class Multithredable implements Runnable {

        //Class variables
        ServerSocket serverSocket;

        //Constructor
        public Multithredable(ServerSocket serverSocket){
